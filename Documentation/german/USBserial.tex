...
Nach diesen Angaben und eigenen Experimenten habe ich die Tabellen~\ref{tab:CH340baudl} und~\ref{tab:CH340baudh}erstellt.
Weil sich mit dem neueren Betriebssystem Linux Mint 18.3 teilweise bessere Ergebnisse ergeben haben, habe ich die Meßergebnisse mit diesem System gemessen.
