...
Unter dem Linux-Betriebssystem gibt es ein Werkzeug (Tool) mit dem seltsamen Namen \textbf{jpnevulator}, mit dem
...
Einige Anwendungen wie \textbf{avrdude} können die Baudrate selber einstellen.
...
Daneben hat dat Programm \textbf{avrdude} die Möglichkeit, die Aktivitäten zu protokollieren.
